...
function displaySinglePainting (pData, imgElement) {
    ...
    let colors = document.querySelector('#colorList');
...
//function addHeaderClickListeners(PaintingH4) {
//    for (let ph of PaintingH4) {
...
function processPaintingsInfo(id, sortBase) {
    ...
    document.querySelector("#title th").innerHTML = "";
    document.querySelector("#title th").appendChild(imgGif);
